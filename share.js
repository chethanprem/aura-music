...
// NAVIGATION
// ═══════════════════════════════════════════════════════
// Bottom nav has only 4 tabs now — Playlists moved inside
// Library (accessed via pill), and Equalizer lives inside
// Settings. Both still have their own screen + back button.
const TABS = ['home','search','library','settings'];

function switchTab(tab){
  const navTabs    = ['home','search','library','settings'];
  const allScreens = [...navTabs, 'playlists', 'eq'];
